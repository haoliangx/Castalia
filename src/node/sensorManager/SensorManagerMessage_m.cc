//
// Generated file, do not edit! Created by opp_msgc 4.1 from src/node/sensorManager/SensorManagerMessage.msg.
//
...
SensorReadingMessage::SensorReadingMessage(const SensorReadingMessage& other) : cMessage()
{
...
void SensorReadingMessage::setSensedValue(double sensedValue_var)
{
    this->sensedValue_var = sensedValue_var;
}
...
void SensorReadingMessage::setSensorType(const char * sensorType_var)
{
    this->sensorType_var = sensorType_var;
}
...
void SensorReadingMessage::setSensorIndex(int sensorIndex_var)
{
