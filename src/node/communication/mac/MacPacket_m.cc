...
MacPacket::MacPacket(const MacPacket& other) : cPacket()
{
...
void MacPacket::setMacRadioInfoExchange(const MacRadioInfoExchange_type& macRadioInfoExchange_var)
{
    this->macRadioInfoExchange_var = macRadioInfoExchange_var;
}
...
void MacPacket::setSource(int source_var)
{
...
void MacPacket::setDestination(int destination_var)
{
...
void MacPacket::setSequenceNumber(unsigned int sequenceNumber_var)
{
...
void MacControlMessage::setMacControlMessageKind(int macControlMessageKind_var)
{
    this->macControlMessageKind_var = macControlMessageKind_var;
}
