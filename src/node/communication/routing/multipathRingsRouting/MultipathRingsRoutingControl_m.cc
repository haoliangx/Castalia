//
// Generated file, do not edit! Created by opp_msgc 4.1 from src/node/communication/routing/multipathRingsRouting/MultipathRingsRoutingControl.msg.
//
...
MultipathRingsRoutingControlMessage::MultipathRingsRoutingControlMessage(const MultipathRingsRoutingControlMessage& other) : cMessage()
{
...
void MultipathRingsRoutingControlMessage::setMultipathRingsRoutingControlMessageKind(int multipathRingsRoutingControlMessageKind_var)
{
    this->multipathRingsRoutingControlMessageKind_var = multipathRingsRoutingControlMessageKind_var;
}
...
void MultipathRingsRoutingControlMessage::setSinkID(int sinkID_var)
{
...
void MultipathRingsRoutingControlMessage::setLevel(int level_var)
{
