...
MultipathRingsRoutingPacket::MultipathRingsRoutingPacket(const MultipathRingsRoutingPacket& other) : RoutingPacket()
{
...
void MultipathRingsRoutingPacket::setMultipathRingsRoutingPacketKind(int multipathRingsRoutingPacketKind_var)
{
    this->multipathRingsRoutingPacketKind_var = multipathRingsRoutingPacketKind_var;
}
...
void MultipathRingsRoutingPacket::setSinkID(int sinkID_var)
{
...
void MultipathRingsRoutingPacket::setSenderLevel(int senderLevel_var)
{
    this->senderLevel_var = senderLevel_var;
}
