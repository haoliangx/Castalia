//
// Generated file, do not edit! Created by opp_msgc 4.1 from src/node/communication/routing/RoutingPacket.msg.
//
...
RoutingPacket::RoutingPacket(const RoutingPacket& other) : cPacket()
{
...
void RoutingPacket::setNetMacInfoExchange(const NetMacInfoExchange_type& netMacInfoExchange_var)
{
    this->netMacInfoExchange_var = netMacInfoExchange_var;
}
...
void RoutingPacket::setSource(const char * source_var)
{
...
void RoutingPacket::setDestination(const char * destination_var)
{
...
void RoutingPacket::setSequenceNumber(unsigned int sequenceNumber_var)
{
