//
// Generated file, do not edit! Created by opp_msgc 4.1 from src/node/resourceManager/ResourceManagerMessage.msg.
//
...
ResourceManagerMessage::ResourceManagerMessage(const ResourceManagerMessage& other) : cMessage()
{
...
void ResourceManagerMessage::setPowerConsumed(double powerConsumed_var)
{
    this->powerConsumed_var = powerConsumed_var;
}
