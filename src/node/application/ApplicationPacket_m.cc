//
// Generated file, do not edit! Created by opp_msgc 4.1 from src/node/application/ApplicationPacket.msg.
//
...
ApplicationPacket::ApplicationPacket(const ApplicationPacket& other) : cPacket()
{
...
void ApplicationPacket::setAppNetInfoExchange(const AppNetInfoExchange_type& appNetInfoExchange_var)
{
    this->appNetInfoExchange_var = appNetInfoExchange_var;
}
...
void ApplicationPacket::setApplicationID(const char * applicationID_var)
{
    this->applicationID_var = applicationID_var;
}
...
void ApplicationPacket::setSequenceNumber(unsigned int sequenceNumber_var)
{
...
void ApplicationPacket::setData(double data_var)
{
