//
// Generated file, do not edit! Created by opp_msgc 4.1 from src/helpStructures/TimerServiceMessage.msg.
//
...
TimerServiceMessage::TimerServiceMessage(const TimerServiceMessage& other) : cMessage()
{
...
void TimerServiceMessage::setTimerIndex(int timerIndex_var)
{
