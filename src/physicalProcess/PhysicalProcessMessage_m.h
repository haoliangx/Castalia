...
class PhysicalProcessMessage : public ::cMessage
{
  ...
  public:
    ...
    virtual void setValue(double value_var);
    virtual double getXCoor() const;
    virtual void setXCoor(double xCoor_var);
    virtual double getYCoor() const;
    virtual void setYCoor(double yCoor_var);
    virtual int getSrcID() const;
    virtual void setSrcID(int srcID_var);
    virtual int getSensorIndex() const;
    virtual void setSensorIndex(int sensorIndex_var);
};
